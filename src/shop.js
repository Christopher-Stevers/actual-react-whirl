...
function Shop() {
    ...
    const toggle = () => {
        ...
        isClosed ? updateIsClosed(false) : updateIsClosed(true); };

    return (<div className={style.grid}>
        <Header title="Our Products" />
        <div className={style.sticky}>
            <div onClick={toggle}> {
                isClosed ? <div><div className={style.x}>x</div><Navbar />
                    ...
                    : <div className={style.svgWrapper}><svg className={style.svg} role="button" id="icon" onClick={toggle} width="55" height="45">
